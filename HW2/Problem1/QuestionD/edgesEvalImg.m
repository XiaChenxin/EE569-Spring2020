function [thrs,cntR,sumR,cntP,sumP,V] = edgesEvalImg( E, G,i,varargin)
...
dfs={ 'out','', 'thrs',9, 'maxDist',.0075, 'thin',1 };
...
G=load(G); G=G.groundTruth; n=i;
for g=n:n, G{g}=double(G{g}.Boundaries); end
