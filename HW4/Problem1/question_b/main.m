...
feature3_test = pca_hand(feature_test(:,2:15),3);
...
trees15 = TreeBagger(50,feature_sample(:,2:15),label,'method','classification');
PCA_result15 = predict(trees15,feature_test(:,2:15))
trees3 = TreeBagger(50,feature3_sample,label,'method','classification');
